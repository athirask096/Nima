                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            {
                                       ?>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Customer ID</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter customer id" name="bid" value="<?=$row->u_id;?>" required readonly/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Customer Name</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter customer name" name="bname" value="<?=$row->u_name;?>" required/></div>
                                            <div class="form-group"><label class="small mb-1" for="inputEmailAddress">Delivery Address</label><input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter delivery address" name="bname" value="<?=$row->u_address;?>" required/></div>
